...
namespace API.Services.UsuarioServices.Commands.LoginUsuarioCommand
{
  public class LoginUsuarioCommandHandler : IRequestHandler<LoginUsuarioCommand, UsuarioDto>
  {
    ...
    public LoginUsuarioCommandHandler(LagranferiaminoristaContext context, IMapper mapper, IValidator<LoginUsuarioCommand> validator, IOptions<JwtSetings> options)
    {
      _context = context;
      _mapper = mapper;
